    ...
    const{id} = useParams(); 
          ...
          function addToCart() {
            ...
            if (!itemExist){
                ...
                toast.success("cart items addes successfully")
            }
    ...
    return  product && <div className="container container-fluid">
        <div className="row f-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
                ...
                <p>Status: <span id="stock_status" className={ product.stock > 0 ? 'text-success' : 'text-danger'}>{product.stock ? 'In Stock' : 'out of stock'}</span></p>
                ...
                <div classNameName="rating w-50"></div>
